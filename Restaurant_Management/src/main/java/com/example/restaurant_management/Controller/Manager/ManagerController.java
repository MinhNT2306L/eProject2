...
import com.example.restaurant_management.Controller.EmployeeController;
...
public class ManagerController {
    ...
    public void showEmployeeManager(ActionEvent event) {
        ...
        try {
            ...
            employeeController.setModal(addEmployeeModal, addController);
            contentArea.getChildren().add(addEmployeeModal);

            VBox.setVgrow(employeeViewContent, Priority.ALWAYS);
            HBox.setHgrow(employeeViewContent, Priority.ALWAYS);
            employeeViewContent.setMaxWidth(Double.MAX_VALUE);
            employeeViewContent.setMaxHeight(Double.MAX_VALUE);

            customerView.getChildren().add(employeeViewContent);
