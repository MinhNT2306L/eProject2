...
public class TableRepo extends EntityRepo<Table> {
    ...
    public TableRepo(Connection conn, RowMapper<Table> mapper) {
        super(conn, mapper, "ban");
    }
    ...
    public void updateTableStatus(int banId, String trangThai) throws SQLException {
